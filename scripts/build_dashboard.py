...
ANSWERS = {
    ...
    "PRICING": "**USD 1.950** por el programa completo. Reserva de cupo: **USD 199** (se descuenta del total). Aceptamos tarjeta de crédito y transferencia bancaria; si necesitás otra opción, lo coordinamos con admisiones. Por la cantidad de templates, los +100K créditos de Dapta y la mentoría en vivo con Nicolás Rojas y Andrés Bilbao, el ROI se mide en deals cerrados las primeras semanas, no en costo recuperado.",
...
<div class="meta-footer">
  <div class="meta-footer-inner">
    ...
    <div>
      <h4>Próxima cohorte</h4>
      <p style="color: var(--accent); font-family: var(--mono); font-size: 12px;">CUPOS LIMITADOS · 100 PERSONAS.</p>
      <p style="margin-top: 12px;">USD 1.950 · reserva USD 199 · 4 semanas · 8 sesiones en vivo. Mentores: <strong style="color: var(--accent);">Nicolás Rojas (Dapta) + Andrés Bilbao (Rappi)</strong>. <a href="__CURSO_URL__" target="_blank" style="color: var(--accent); text-decoration: underline;">Aplicar al programa →</a></p>
    </div>
  </div>
</div>
...
- Precio USD 1.950. Reserva cupo USD 199. Limitado a 100 cupos. +100K créditos Dapta gratis. Certificado oficial 30X Executive Education.
...
5. Call to action: agendar llamada (${CALENDLY_URL}) o reservar cupo (USD 199 vía ${CURSO_URL}).
